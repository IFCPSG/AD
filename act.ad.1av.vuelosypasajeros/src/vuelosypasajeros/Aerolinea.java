package vuelosypasajeros;
        ...
        import static vuelosypasajeros.Constantes.Pasajero.FUMADOR;
        import static vuelosypasajeros.Constantes.Vuelo.*;
...
public class Aerolinea {
    ...
    private void opcionesMenu(BufferedReader entradaDatos, int opcionSeleccionada) throws IOException {
        ...
        switch (opcionSeleccionada) {
            case 0:
                System.out.println("Moltes gràcies per utilitzar l'aplicació. Bon viatge i dali cebes");
                break;
            case 1:

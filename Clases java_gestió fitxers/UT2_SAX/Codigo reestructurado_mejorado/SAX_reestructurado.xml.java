...
public class Main {
    ...
    private static void leerXML(Path path) {
        ...
        try {
            ...
            System.err.println("No se ha podido cear el nuevo SaxParser");
        ...
        try {
           ...
           /* reader.setContentHandler(new DefaultHandler() {
                ...
                public void startDocument() throws SAXException {
                    super.startDocument();
                    System.out.println("Inciando documento...");
                }
                @Override
                public void startElement(String uri , String localName , String qName , Attributes attributes) throws SAXException {
                    ...
                    switch (qName) {
                        ...
                        case "Test":
                            ...
                            //RECUOERAR LOS ATRIBUTOS
                            break;
                        case "Name":
                            System.out.print("\t\tNombre del texto :\t");
                            break;
                        case "CommandLine":

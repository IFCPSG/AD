...
public class Main {
    public static void main(String[] args) {
        ...
        String crearTablaPersona ="create table if not exists Persona(id INTEGER PRIMARY KEY AUTO_INCREMENT, nombre VARCHAR(30) NOT NULL, password VARCHAR(30) NOT NULL, telefono INTEGER(9) NOT NULL)";
        ...
        System.out.println("Introduce el password de la persona:");
        String passwordUser = scanner.nextLine();
        String buscarPersona = "select * from Persona where id=? and password=?;";
        ResultSet resultSet = JDBCOpearations.buscarDatos(connection, buscarPersona, id, passwordUser);
        if (resultSet != null) {
            try {
                while (!resultSet.isLast()) {
                    ...
                    System.out.println(nombreBD+"\t"+passwordBD+"\t"+telefonoBD);

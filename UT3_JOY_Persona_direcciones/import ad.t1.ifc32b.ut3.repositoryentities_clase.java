...
public class PersonaRepository implements Repository<Persona> {
    ...
    public PersonaRepository(Connection connection) {this.connection = connection;}
        ...
        try {
            ...
            while (!resultSet.isLast()) {
                ...
                if(personas.contains(persona)){
                    ...
                    System.err.println("La Persona NO está en la lista");
                }
    ...
    public void deleteById(int id) {
        String query = "delete from personas where id =? set NOMBRE = ?";
        PreparedStatement estado = JDBCOpearations.crearSentencia(connection , query);
        try {
            estado.setInt(1 , id);
            estado.executeUpdate();
